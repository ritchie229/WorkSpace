https://www.tecmint.com/install-gui-desktop-rocky-linux-9/ <br>

## How to Install GNOME Desktop (GUI) On Rocky Linux 9
Narendra KLast Updated: October 25, 2022 Read Time: 4 minsCategoriesRocky Linux 1 Comment <br>
...
- A user with superuser privileges. In our case, this will be a root user which is indicated by the hash (#) prompt.
- At least 2 GB of RAM with an additional 1 GB of disk space.
> [!NOTE]
...
```
#### Check Installed Base Environment
...
#### List Available Base Environments
...
#### GUI Installation Summary
Let’s type `y` and press the `enter` key to begin the installation.
